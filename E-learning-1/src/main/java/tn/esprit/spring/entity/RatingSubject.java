...
public class RatingSubject implements Serializable {
	...
	public RatingSubject(RatingValue rating_value, Date date_value, User client, SubjectForum subjectforum) {
		super();
		this.rating_value = rating_value;
		this.date_value = date_value;
		this.client = client;
	...
	public RatingSubject(int id_rating, RatingValue rating_value, Date date_value, User client,
